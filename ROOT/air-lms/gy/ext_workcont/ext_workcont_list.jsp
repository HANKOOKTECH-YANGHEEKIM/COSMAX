...
<%
	...
	String jsonDataUrl = "/ServletController"
	   		   ...
	   		   + "&AIR_MODE=GY_EXT_WORKCONT_JSON_LIST";
...
<div id="listTabsLayer" class="easyui-tabs" data-options="border:false,plain:true" style="width:auto;height:auto">
	...
	<form name="form1">
	<input type="hidden" name="MAS_TYPE" value="GY" data-type="search" />
		<table class="box">
		<tr>
...
<%-- 								<%=HtmlUtil.getSelect(request, true, "HOESA_COD", "HOESA_COD", HOESA_CODESTR, "", "class=\"select width_max\" data-type=\"search\" style='width:100%;'")%> --%>
							...
							<td>
								<input type="text" name="YOCHEONG_DPT_NAM" onkeydown="doSearch(document.form1, true)" maxlength="10" data-type="search" class="text width_max" />
							</td>
						...
						<tr>																
							...
							<td colspan="3">
								<input type="text" name="MAS_TIT" onkeydown="doSearch(document.form1, true);" maxlength="40" data-type="search" class="text" style="width:99.2%;" />
							</td>
		...
		<table id="listTable" style="height:auto;clear:both">
			...
			<tr>
				...
				<th data-options="field:'MAS_TIT',width:120,halign:'CENTER',align:'LEFT',editor:'text',sortable:true"><%=StringUtil.getLang("L.계약명", siteLocale)%></th>
