...
<%
if(!masMap.getString("STU_ID").startsWith("JM_REQ")){//-- 요청 단계에서는 하다탬 표출안함
	
String workCont = "/ServletController?AIR_ACTION=LMS_GT_WORKCONT&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;		//-- 업무연락
String lawMemo = "/ServletController?AIR_ACTION=LMS_GT_LAW_MEMO&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;			//-- 법무팀메모
String extLawEmploy = "/ServletController?AIR_ACTION=LMS_GT_EXT_EMPLOY&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;		//-- 외부변호사위임
String extWorkCont = "/ServletController?AIR_ACTION=LMS_GT_EXT_WORKCONT&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;//-- 외부변호사 업무연락
String extEval = "/ServletController?AIR_ACTION=LMS_GT_EXT_EVAL&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;		//-- 외부변호사 평가
String costMng = "/ServletController?AIR_ACTION=LMS_GT_COST_MNG&AIR_MODE=LIST&gbn=JM&sol_mas_uid="+sol_mas_uid;		//-- 비용관리
%>
