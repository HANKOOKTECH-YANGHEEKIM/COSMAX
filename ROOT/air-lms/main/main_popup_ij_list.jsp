...
<div id="listTabsLayer" class="easyui-tabs" data-options="border:false,plain:true" style="width:auto;height:auto">
	<table id="listTable" style="width:auto;height:auto">       
        ...
        <tr>
            ...
            <th data-options="field:'INJANG_TIT',width:450,halign:'center',align:'left'"><%=StringUtil.getLocaleWord("L.제목",siteLocale) %></th>
<%--             <th data-options="field:'INJANG_TYPE_NM',width:100,halign:'center',align:'center'"><%=StringUtil.getLocaleWord("L.인감종류",siteLocale) %></th> --%>
            <th data-options="field:'SEORYU_TYPE_NM',width:150,halign:'center',align:'center'"><%=StringUtil.getLocaleWord("L.서류유형",siteLocale) %></th>
            <th data-options="field:'YOCHEONG_DPT_NM',width:160,halign:'center',align:'center'"><%=StringUtil.getLocaleWord("L.의뢰부서",siteLocale) %></th>
            <th data-options="field:'YOCHEONG_NM',width:100,halign:'center',align:'center'"><%=StringUtil.getLocaleWord("L.의뢰자",siteLocale) %></th>
 	...
 	$("#listTable").datagrid({
		...
		nowrap:false,
 		...
 		onClickRow:function(rowIndex,rowData) {
			...
			url += "?AIR_ACTION=LMS_IJ_LIST_MAS";
