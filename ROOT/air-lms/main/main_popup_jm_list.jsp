...
<%
    ...
    String 의뢰부서 = StringUtil.getLocaleWord("L.의뢰부서",siteLocale);
    String 요청일 = StringUtil.getLocaleWord("L.요청일",siteLocale);
    String 회신일 = StringUtil.getLocaleWord("L.회신일",siteLocale);
    String 관리번호 = StringUtil.getLocaleWord("L.관리번호",siteLocale);
    String jsonDataUrl = "/ServletController"
            + "?AIR_ACTION=LMS_JM_LIST_MAS"  
            + "&AIR_MODE=JSON_LIST";
%>
<form name="form1">
	...
	<table id="listTable" style="width:auto;height:auto">       
        ...
        <tr>    
        	<th data-options="field:'SOL_MAS_UID',width:0,hidden:true"></th>
			 <th data-options="field:'GWANRI_NO',width:100,halign:'center',align:'center',sortable:'true'"><%= 관리번호 %></th>
            <th data-options="field:'JAMUN_TIT',width:510,halign:'center',align:'left',sortable:'true'"><%=제목 %></th>
            <th data-options="field:'YOCHEONG_DPT_NAM',width:160,halign:'center',align:'center',sortable:'true'"><%=의뢰부서 %></th>
            <th data-options="field:'YOCHEONG_DTE',width:100,halign:'center',align:'center',sortable:'true'"><%=요청일 %></th>
            <th data-options="field:'GEOMTO_DTE',width:100,halign:'center',align:'center',sortable:'true'"><%=회신일 %></th>
        </tr>
        </thead>
    </table>
</div>
 	...
 	$("#listTable").datagrid({
		...
		nowrap:false,
 		...
 		onClickRow:function(rowIndex,rowData) {
			...
			url += "?AIR_ACTION=LMS_JM_LIST_MAS";
